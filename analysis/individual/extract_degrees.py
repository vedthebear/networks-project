...
# Intermediate output — degree CSVs consumed by analyze_degrees.py
OUT_DIR = SCRIPT_DIR / "data" / "degrees"
OUT_DIR.mkdir(parents=True, exist_ok=True)

REDDIT_TSV = ROOT / "data" / "reddit" / "soc-redditHyperlinks-body.tsv"
V2_GRAPHS  = ROOT / "data" / "graphs"
V2_TABLES  = ROOT / "data" / "data" / "tables"
...
def extract_moltbook() -> None:
    ...
    # moltbook_full_degree omitted — full graph archived; core is the paper graph
